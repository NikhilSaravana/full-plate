...
const translations = {
  en: {
    ...
    'btn.reset': 'Reset',
    'btn.start-tour': 'Start Guided Tour',
    ...
    'tour.global-search.title': 'Global Search',
    'tour.global-search.content': 'Use this search bar to quickly find items across inventory, distributions, and reports. Just start typing to see results.',
    'tour.single-bulk-tabs.title': 'Single vs Bulk Entry',
    'tour.single-bulk-tabs.content': 'Choose between Single Entry for adding items one-by-one, or Bulk Import to paste multiple items at once from spreadsheets.',
    'tour.entry-metadata.title': 'Entry Details',
    'tour.entry-metadata.content': 'Record the date, source of donation (Direct, NTFB, Farm, etc.), and any notes about this intake batch.',
    'tour.quick-add.title': 'Quick Add Common Items',
    'tour.quick-add.content': 'Speed up data entry by clicking these buttons to instantly add frequently donated items like milk, bread, and produce.',
    'tour.add-item.title': 'Add More Items',
    'tour.add-item.content': 'Click here to add additional rows to your intake form. Each item can have its own category, product name, quantity, unit, and expiration date.',
    'tour.submit-data.title': 'Submit Survey',
    'tour.submit-data.content': 'Once you\'ve entered all items, click this button to save your inventory data and update your totals.',
    'tour.recipient-info.title': 'Recipient Information',
    'tour.recipient-info.content': 'Enter who is receiving this distribution - community centers, schools, churches, or individual client names.',
    'tour.age-demographics.title': 'Age Demographics',
    'tour.age-demographics.content': 'Record the number of children (0-17), adults (18-64), and elderly (65+) served. Total clients is calculated automatically from these values.',
    'tour.alerts-panel.title': 'Alerts & Warnings',
    'tour.alerts-panel.content': 'Monitor critical alerts here for items nearing expiration, low stock levels, and nutritional imbalances to prevent waste.',
    'tour.quick-actions.title': 'Quick Actions',
    'tour.quick-actions.content': 'Jump directly to common tasks from this shortcut panel: add inventory, check MyPlate compliance, or manage existing items.',
    'tour.submit-distribution.title': 'Record Distribution',
    'tour.submit-distribution.content': 'After entering client details and distributed items, click here to record the distribution event and update your metrics.',
    'tour.myplate-table.title': 'MyPlate Category Breakdown',
    'tour.myplate-table.content': 'This table breaks down your inventory by food groups (Vegetables, Fruit, Dairy, Grains, Protein). Each row shows your current amounts compared to USDA MyPlate nutritional guidelines.',
    'tour.myplate-status.title': 'Understanding the Columns',
    'tour.myplate-status.content': 'Current shows what you have now, Current % is your distribution, Goal % is USDA target, Status shows UNDER/GOOD/OVER, Target is your goal amount, and Need to Order tells you what to add for nutritional balance.',
    'tour.report-types.title': 'Report Generation',
    'tour.report-types.content': 'Select from various report types for grant documentation.',
    'tour.help-button.title': 'Help & Support',
    'tour.help-button.content': 'Need assistance? Click here to access help documentation, keyboard shortcuts, and contact information for technical support.',
    ...
    'survey.upload-csv-txt': 'Upload CSV/TXT',
    'survey.upload-xlsx': 'Upload Excel (.xlsx)',
    'survey.import-success': 'Import Complete',
    'survey.import-success-message': 'Your file was imported successfully.',
    ...
    // Alert Messages
    'alerts.inventory-critically-low': '{category} inventory critically low ({percentage}%)',
    'alerts.inventory-low': '{category} inventory low ({percentage}%)',
    'alerts.consider-immediate-restocking': 'Consider immediate restocking',
    'alerts.plan-restocking-soon': 'Plan for restocking soon',
    'alerts.myplate-imbalance': 'Only {compliantCategories}/5 MyPlate categories are balanced',
    'alerts.review-distribution-targets': 'Review distribution targets',
    ...
    'inventory.detailed-management-note': 'For more detailed inventory management, add individual items with expiration dates and specific details.',
  ...
  es: {
    ...
    'tour.global-search.title': 'Búsqueda Global',
    'tour.global-search.content': 'Use esta barra de búsqueda para encontrar rápidamente artículos en inventario, distribuciones y reportes. Solo comience a escribir para ver resultados.',
    'tour.single-bulk-tabs.title': 'Entrada Individual vs Masiva',
    'tour.single-bulk-tabs.content': 'Elija entre Entrada Individual para agregar artículos uno por uno, o Importación Masiva para pegar múltiples artículos a la vez desde hojas de cálculo.',
    'tour.entry-metadata.title': 'Detalles de Entrada',
    'tour.entry-metadata.content': 'Registre la fecha, fuente de donación (Directa, NTFB, Granja, etc.) y cualquier nota sobre este lote de ingreso.',
    'tour.quick-add.title': 'Agregar Rápidamente Artículos Comunes',
    'tour.quick-add.content': 'Acelere la entrada de datos haciendo clic en estos botones para agregar instantáneamente artículos donados frecuentemente como leche, pan y productos frescos.',
    'tour.add-item.title': 'Agregar Más Artículos',
    'tour.add-item.content': 'Haga clic aquí para agregar filas adicionales a su formulario de ingreso. Cada artículo puede tener su propia categoría, nombre de producto, cantidad, unidad y fecha de vencimiento.',
    'tour.submit-data.title': 'Enviar Encuesta',
    'tour.submit-data.content': 'Una vez que haya ingresado todos los artículos, haga clic en este botón para guardar sus datos de inventario y actualizar sus totales.',
    'tour.recipient-info.title': 'Información del Destinatario',
    'tour.recipient-info.content': 'Ingrese quién está recibiendo esta distribución - centros comunitarios, escuelas, iglesias o nombres de clientes individuales.',
    'tour.age-demographics.title': 'Demografía por Edad',
    'tour.age-demographics.content': 'Registre el número de niños (0-17), adultos (18-64) y ancianos (65+) atendidos. El total de clientes se calcula automáticamente a partir de estos valores.',
    'tour.alerts-panel.title': 'Alertas y Advertencias',
    'tour.alerts-panel.content': 'Monitoree alertas críticas aquí para artículos próximos a vencer, niveles bajos de stock y desequilibrios nutricionales para prevenir desperdicio.',
    'tour.quick-actions.title': 'Acciones Rápidas',
    'tour.quick-actions.content': 'Salte directamente a tareas comunes desde este panel de accesos directos: agregar inventario, verificar cumplimiento MyPlate o gestionar artículos existentes.',
    'tour.submit-distribution.title': 'Registrar Distribución',
    'tour.submit-distribution.content': 'Después de ingresar los detalles del cliente y los artículos distribuidos, haga clic aquí para registrar el evento de distribución y actualizar sus métricas.',
    'tour.myplate-table.title': 'Desglose de Categorías MyPlate',
    'tour.myplate-table.content': 'Esta tabla desglosa su inventario por grupos de alimentos (Verduras, Frutas, Lácteos, Granos, Proteína). Cada fila muestra sus cantidades actuales comparadas con las pautas nutricionales MyPlate del USDA.',
    'tour.myplate-status.title': 'Entendiendo las Columnas',
    'tour.myplate-status.content': 'Actual muestra lo que tiene ahora, % Actual es su distribución, % Objetivo es la meta del USDA, Estado muestra BAJO/BUENO/SOBRE, Objetivo es su cantidad meta, y Necesita Ordenar le dice qué agregar para equilibrio nutricional.',
    'tour.report-types.title': 'Generación de Reportes',
    'tour.report-types.content': 'Seleccione entre varios tipos de reportes incluyendo resúmenes de inventario, historial de distribución y reportes de cumplimiento para documentación de subvenciones.',
    'tour.help-button.title': 'Ayuda y Soporte',
    'tour.help-button.content': '¿Necesita asistencia? Haga clic aquí para acceder a la documentación de ayuda, atajos de teclado e información de contacto para soporte técnico.',
    ...
    'survey.upload-csv-txt': 'Subir CSV/TXT',
    'survey.upload-xlsx': 'Subir Excel (.xlsx)',
    'survey.import-success': 'Importación Completa',
    'survey.import-success-message': 'Su archivo fue importado correctamente.',
    ...
    // Alert Messages
    'alerts.inventory-critically-low': 'Inventario de {category} críticamente bajo ({percentage}%)',
    'alerts.inventory-low': 'Inventario de {category} bajo ({percentage}%)',
    'alerts.consider-immediate-restocking': 'Considere reabastecimiento inmediato',
    'alerts.plan-restocking-soon': 'Planifique reabastecimiento pronto',
    'alerts.myplate-imbalance': 'Solo {compliantCategories}/5 categorías MyPlate están balanceadas',
    'alerts.review-distribution-targets': 'Revise objetivos de distribución',
    ...
    'inventory.detailed-management-note': 'Para una gestión de inventario más detallada, agregue artículos individuales con fechas de vencimiento y detalles específicos.',
