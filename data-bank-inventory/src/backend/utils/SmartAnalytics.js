...
const SmartAnalytics = ({ inventoryData, distributionData, surveyData }) => {
  const { t } = useLanguage();
  ...
  // Smart analytics analysis function
  const generateSmartRecommendations = async () => {
    ...
    try {
      ...
      showSuccess('Smart Analysis Complete', 'Generated intelligent recommendations based on your data patterns');
    } catch (error) {
      showError('Analysis Failed', 'Could not generate smart recommendations');
    } finally {
    ...
    <div className="smart-analytics">
      ...
      <div className="analytics-controls">
        <button 
          ...
          className="btn btn-primary analytics-generate-btn"
        >
          {isGenerating ? (
            <>
